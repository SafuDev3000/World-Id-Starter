    ...
    <div className="relative grid h-full w-full content-between bg-0f0b16 px-6 pt-5 xs:px-16 xs:pb-4.5 xs:pt-9">
      ...
      >
        <header className="flex items-center py-2.5">
          <p
            className="text-20 font-bold text-f xs:text-32"
            style={{ flexGrow: 1 }}
          >
            Gold Dust
          </p>
        ...
        {screen !== Screen.Congratulations && (
          <div className="grid justify-items-center gap-y-3 justify-self-center text-ffffff xs:gap-y-4">
            <h1 className="text-16 font-bold xs:text-24">
              THE BIGGEST DEGEN AIRDROP IS HERE!
            </h1>

            <div className="mt-2 grid justify-items-center text-48 lg:text-80 xs:mt-0 xs:block">
              <span className="font-black text-ffffff ">Get your $DUST back </span>
              <span className="font-black">in $GOLD</span>
            </div>

            <p className="mb-5 text-center text-14 xs:mb-8 xs:text-18">
              $GOLD is almost live and will be ready to claim. Purchase $DUST & Stake to be able to  claim your $GOLD tokens for
              free.
            </p>
            ...
            {screen === Screen.Initial && (
              <div className="grid justify-items-center gap-y-3 ">
                <Button
                  ...
                  type="button"
                  className="bg-000000 hover:bg-ffffff/70"
                >
                  Connect Wallet to Claim
                </Button>

                <p className="text-14 xs:text-12">
                  We are NOT Live just yet. Go BUY $DUST Tokens to ensure you are Ready to Claim $GOLD.
                </p>
              </div>
            )}
      ...
      {screen === Screen.Initial && (
        <div
          className={cn(
            ...
            "border-t border-ffffff bg-0f0b16 py-3 text-ffffff xs:rounded-10 xs:border xs:text-center",
          )}
        >
          <span>
            Gold Dust is an project dedicated reimbursing all DEGENS worldwide holding "Dust" Shitcoins.{" "}
          </span>
          <a
            href="/"
